...
export const NETWORK_ICON: Record<number, string> = {
  ...
  [ChainId.ZETA]: 'https://i.ibb.co/yRkrrvg/zetachain-icon.png',
  [ChainId.ZETA_TESTNET]: 'https://i.ibb.co/yRkrrvg/zetachain-icon.png',
  // [ChainId.XDAI]: xDai,
...
export const NETWORK_LABEL: Record<number, string> = {
  ...
  // [ChainId.ZETA_TESTNET]: 'ZetaChain Testnet',
