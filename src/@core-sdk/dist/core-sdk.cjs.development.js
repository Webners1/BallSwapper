...
var zetaTestnet = /*#__PURE__*/function (_NativeCurrency) {
  ...
  function zetaTestnet(chainId) {
    return _NativeCurrency.call(this, chainId, 18, 'ZETA', 'ZETA') || this;
  }

  zetaTestnet.onChain = function onChain(chainId) {
    var _this$_cache$chainId;

    return (_this$_cache$chainId = this._cache[chainId]) != null ? _this$_cache$chainId : this._cache[chainId] = new zetaTestnet(chainId);
  };

  var _proto = zetaTestnet.prototype;

  _proto.equals = function equals(other) {
    return other.isNative && other.chainId === this.chainId;
  };

  _createClass(zetaTestnet, [{
    key: "wrapped",
    get: function get() {
      var wnative = WNATIVE[this.chainId];
      !!!wnative ?  invariant(false, 'WRAPPED')  : void 0;
...
var Pair = /*#__PURE__*/function () {
  function Pair(currencyAmountA, currencyAmountB) {
    ...
    this.liquidityToken = new Token(currencyAmounts[0].currency.chainId, Pair.getAddress(currencyAmounts[0].currency, currencyAmounts[1].currency), 18, 'AceSwap-LP', 'AceSwap LPs');
...
exports.xDai = xDai;
exports.zetaTestnet = zetaTestnet;
