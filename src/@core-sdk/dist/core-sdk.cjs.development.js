...
var Zeta = /*#__PURE__*/function (_NativeCurrency) {
  ...
  function Zeta(chainId) {
    return _NativeCurrency.call(this, chainId, 18, 'ETH', 'Zeta') || this;
  }

  Zeta.onChain = function onChain(chainId) {
    var _this$_cache$chainId;

    return (_this$_cache$chainId = this._cache[chainId]) != null ? _this$_cache$chainId : this._cache[chainId] = new Zeta(chainId);
  };
